...
4) Use the search box to filter the overview table and tap or press Enter/Space on a column header to sort (Total Stake defaults to descending). Reset clears the imported data, filters, and cards so you can load a new file.
